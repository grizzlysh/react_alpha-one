...
const InvoiceCreateComponent: React.FC = () => {
  ...
  const getDdlOptions = () => {
    doGetDrug().then(
      (resp: any) => {
        ...
        setDrugOptions(resp.data.output_schema.data)
      } 
    )
    ...
    doGetDistributor().then(
      (resp: any) => {
        ...
        setDistributorOptions(resp.data.output_schema.data)
      } 
    )
  }
  ...
  const onAddInvoiceDetail = (data: InvoiceDetailCreateInput) => {
    ...
    const detailRow = {
      ...
      discount_nominal: data.discount_nominal || 0,
      ppn             : data.ppn ? 11 : 0,
                ...
                >
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Distributor fields is required"
                      },
                    }}
                    render  = { ({ 
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "No Invoice fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Total Invoice fields is required"
                      },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Total Pay fields is required"
                      },
                      // pattern: {
                      //   value: /^(?!0\d)\d+$/g,
                      //   message: "error"
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Total Debt fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                ...
                >
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Invoice Date fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Receive Date fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Due Date fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                ...
                >
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Drug fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Expired Date fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Qty/Pcs fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Qty/Box fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
                ...
                >
                  ...
                  >
                    <Controller
                      ...
                      rules   = {{ 
                        required: {
                          value  : true,
                          message: "Price/Box fields is required"
                        },
                      }}
                      render  = { ({ 
                          field     : { onChange, value },
                  ...
                  <Controller
                    ...
                    rules   = {{ 
                      required: {
                        value  : true,
                        message: "Total Price fields is required"
                      },
                    }}
                    render  = { ({ 
                        field     : { onChange, value },
